...
# Create a list with genes (identified using VEP tool) that are located near two different SNP markers 
# identified significantly associated in GWAS 
gene_lists <- list(
...
publish_gostplot(p2, highlight_terms = c("GO:0051020", "GO:0001501", "GO:0009952")) #or gostres$result[c(1, 5, 10),] #NULL
